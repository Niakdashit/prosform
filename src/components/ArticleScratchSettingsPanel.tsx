...
interface ArticleScratchSettingsPanelProps {
...
export const ArticleScratchSettingsPanel: React.FC<ArticleScratchSettingsPanelProps> = ({
  articleConfig,
...
export default ArticleScratchSettingsPanel;
